...
common["run_name"] = (
    "{}+{}+{}".format(
        "TP1", common["hyper_parameters"]["shaking_type"], common["encoder"]
    )
    + ""
)
...
train_config = {
    ...
    "path_to_save_model": "D:/Spyder/xiaoi/tplinker-ch/default_log_dir/{}".format(
        run_id
    ),
