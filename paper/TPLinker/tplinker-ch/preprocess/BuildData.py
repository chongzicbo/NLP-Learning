...
json.dump(
    rel2id, open(rel2id_path, "w", encoding="utf-8"), ensure_ascii=False, indent=2
)
logging.info("rel2id is output to {}".format(rel2id_path))

ent2id_path = os.path.join(data_out_dir, "ent2id.json")
json.dump(
    ent2id, open(ent2id_path, "w", encoding="utf-8"), ensure_ascii=False, indent=2
)
