...
def train_glove_emb(
    corpus, window=10, emb_dim=100, learning_rate=0.05, epochs=10, thr_workers=6
):
    corpus_model = Corpus()
    ...
    glove.fit(corpus_model.matrix, epochs=epochs, no_threads=thr_workers, verbose=True)
...
save_path = os.path.join(
    "../pretrained_word_emb", "glove_{}_{}.emb".format(emb_dim, experiment_name)
)
