...
if choice == 'roformer':
    args_model_path = "/mnt/e/working/huada_bgi/data/pretrained_model/huggingface/roformer/"
    args_model = 'roformer'
else:
    args_model_path = "/mnt/e/working/huada_bgi/data/pretrained_model/huggingface/roformer"
...
model = build_transformer_model(config_path, checkpoint_path, model=args_model, with_mlm='softmax')
