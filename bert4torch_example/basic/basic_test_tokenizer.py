...
@author: chengbo
@software: PyCharm
@file: basic_test_tokenizer.py
@time: 2022/9/17 17:31
"""
...
if choice:
    ...
    tokenizer_bert4torch = tokenizer = SpTokenizer(
