...
for i in range(12):
    ...
    mapping.update(
        {
            prefix
            + "attention/self/query/kernel": prefix_i
            + "attention.self.query.weight##T",
            prefix
            + "attention/self/query/bias": prefix_i
            + "attention.self.query.bias",
            prefix
            + "attention/self/key/kernel": prefix_i
            + "attention.self.key.weight##T",
            prefix + "attention/self/key/bias": prefix_i + "attention.self.key.bias",
            prefix
            + "attention/self/value/kernel": prefix_i
            + "attention.self.value.weight##T",
            prefix
            + "attention/self/value/bias": prefix_i
            + "attention.self.value.bias",
            prefix
            + "attention/output/dense/kernel": prefix_i
            + "attention.output.dense.weight##T",
            prefix
            + "attention/output/dense/bias": prefix_i
            + "attention.output.dense.bias",
            prefix
            + "attention/output/LayerNorm/beta": prefix_i
            + "attention.output.LayerNorm.bias",
            prefix
            + "attention/output/LayerNorm/gamma": prefix_i
            + "attention.output.LayerNorm.weight",
            prefix
            + "intermediate/dense/kernel": prefix_i
