...
@author: chengbo
@software: PyCharm
@file: task_sentence_similarity_lcqmc.py
@time: 2022/8/10 22:48
"""
...
train_dataloader = DataLoader(
    MyDataset(train_data_path),
    batch_size=batch_size,
    shuffle=True,
    collate_fn=collate_fn,
)
valid_dataloader = DataLoader(
    MyDataset(valid_data_path), batch_size=batch_size, collate_fn=collate_fn
)
test_dataloader = DataLoader(
    MyDataset(test_data_path), batch_size=batch_size, collate_fn=collate_fn
)
