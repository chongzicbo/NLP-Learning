...
@author: chengbo
@software: PyCharm
@file: task_sentiment_TemporalEnsembling.py
@time: 2022/8/12 9:58
"""
...
class MyLoss(TemporalEnsemblingLoss):
    def forward(self, y_pred, y_true):
        ...
        return super().forward(
            y_pred_sup, y_pred_unsup, y_true_sup, model.epoch, model.bti
        )


loss = MyLoss(epochs=epochs, max_batch_num=None)
model.compile(
    loss=loss, optimizer=optim.Adam(model.parameters(), lr=2e-5), metrics=["accuracy"]
)
