...
class Model(BaseModel):
    def __init__(self, pool_method='cls') -> None:
        ...
        self.bert = build_transformer_model(config_path=config_path, checkpoint_path=checkpoint_path, dropout_rate=0.3,
                                            segment_vocab_size=0, with_pool=True)
