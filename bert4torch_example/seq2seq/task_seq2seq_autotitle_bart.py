...
@author: chengbo
@software: PyCharm
@file: task_seq2seq_autotitle_bart.py
@time: 2022/8/10 23:10
"""
...
train_dataloader = DataLoader(
    ListDataset(
        glob.glob("F:/Projects/data/corpus/sentence_classification/THUCNews/*/*.txt")
    ),
...
model.compile(
    ...
    optimizer=optim.Adam(model.parameters(), 1.5e-5),
)
