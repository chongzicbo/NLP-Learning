...
@author: chengbo
@software: PyCharm
@file: task_seq2seq_ape210k_math_word_problem.py
@time: 2022/8/12 10:23
"""
# 用Seq2Seq做小学数学应用题
...
train_dataloader = DataLoader(
    MyDataset("F:/Projects/data/corpus/seq2seq/ape210k/train.ape.json"),
...
autosolve = AutoSolve(
    start_id=None, end_id=tokenizer._token_end_id, maxlen=64, device=device
)
...
if __name__ == "__main__":
    evaluator = Evaluator()
    model.fit(
        train_dataloader, steps_per_epoch=500, epochs=epochs, callbacks=[evaluator]
    )
else:
