...
@author: chengbo
@software: PyCharm
@file: task_seq2seq_autotitle.py
@time: 2022/8/8 20:07
"""
...
token_dict, keep_tokens = load_vocab(dict_path=vocab_path, simplified=True,
...
train_dataloader = DataLoader(
    ListDataset(glob.glob('/mnt/e/opensource_data/分类/新闻分类英文--THUCNews/THUCNews/*/*.txt')),
...
class CrossEntropyLoss(nn.CrossEntropyLoss):
    ...
    def forward(self, outputs, target):
        ...
        y_true = y_true[:, 1:]  # 目标token_ids,不包含[CLS]
        y_mask = y_mask[:, 1:]
        y_pred = y_pred[:, :-1, :]
