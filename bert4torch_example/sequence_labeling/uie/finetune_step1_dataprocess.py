...
@author: chengbo
@software: PyCharm
@file: finetune_step1_dataprocess.py
@time: 2022/8/12 9:54
"""
# 数据转换1
import os
    ...
    with open(input_path, "r", encoding="utf-8") as fp:
        ...
        for line in lines:
            ...
            if len(line) == 2:
                ...
                if entity_tmp and (
                    ("".join(entity_tmp), entity_label) not in entities_tmp
                ):
                    entities_tmp.append(("".join(entity_tmp), entity_label))
                    entity_tmp, entity_label = [], ""
...
preprocess(
    "F:/Projects/data/corpus/ner/china-people-daily-ner-corpus/example.test",
    "./data/mid_data",
    "test",
)
