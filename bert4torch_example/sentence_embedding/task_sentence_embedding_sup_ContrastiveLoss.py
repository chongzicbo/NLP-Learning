...
train_dataloader = DataLoader(
    MyDataset("F:/Projects/data/corpus/sentence_embedding/LCQMC/LCQMC.train.data"),
    batch_size=batch_size,
    shuffle=True,
    collate_fn=collate_fn,
)
valid_dataloader = DataLoader(
    MyDataset("F:/Projects/data/corpus/sentence_embedding/LCQMC/LCQMC.valid.data"),
    batch_size=batch_size,
    collate_fn=collate_fn,
)
test_dataloader = DataLoader(
    MyDataset("F:/Projects/data/corpus/sentence_embedding/LCQMC/LCQMC.test.data"),
    batch_size=batch_size,
    collate_fn=collate_fn,
)
...
class Model(BaseModel):
    ...
    def forward(self, token1_ids, token2_ids):
        ...
        pool_emb1 = get_pool_emb(
            hidden_state1, pool_cls1, token1_ids.gt(0).long(), self.pool_method
        )

        hidden_state2, pool_cls2 = self.bert([token2_ids])
        pool_emb2 = get_pool_emb(
            hidden_state2, pool_cls2, token2_ids.gt(0).long(), self.pool_method
        )
