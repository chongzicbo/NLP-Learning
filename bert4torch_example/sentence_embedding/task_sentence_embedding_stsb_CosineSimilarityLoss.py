...
train_dataloader = DataLoader(
    MyDataset("F:/Projects/data/corpus/sentence_embedding/STS-B/STS-B.train.data"),
    batch_size=batch_size,
    shuffle=True,
    collate_fn=collate_fn,
)
valid_dataloader = DataLoader(
    MyDataset("F:/Projects/data/corpus/sentence_embedding/STS-B/STS-B.valid.data"),
    batch_size=batch_size,
    collate_fn=collate_fn,
)
test_dataloader = DataLoader(
    MyDataset("F:/Projects/data/corpus/sentence_embedding/STS-B/STS-B.test.data"),
    batch_size=batch_size,
    collate_fn=collate_fn,
)
