...
@author: chengbo
@software: PyCharm
@file: task_sentence_embedding_sup_concat_CrossEntropyLoss.py
@time: 2022/8/12 9:41
"""
...
class Model(BaseModel):
    def __init__(self, pool_method='cls', concatenation_sent_rep=True, concatenation_sent_difference=True,
