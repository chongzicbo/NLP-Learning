...
class CollateFunc(object):
    ...
    def __call__(self, batch_text):
        ...
        if batch_neg_tokens_list:
            batch_neg_tokens_list = torch.tensor(sequence_padding(batch_neg_tokens_list), dtype=torch.long,
                                                 device=device)
...
train_dataloader = DataLoader(ListDataset(data=train_texts), shuffle=True, batch_size=batch_size,
