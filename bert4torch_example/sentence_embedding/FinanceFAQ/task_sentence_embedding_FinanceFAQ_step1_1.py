...
@author: chengbo
@software: PyCharm
@file: task_sentence_embedding_FinanceFAQ_step1_1.py
@time: 2022/8/12 10:33
"""
...
class Evaluator(Callback):
    ...
    def on_epoch_end(self, global_step, epoch, logs=None):
        perf = evaluate(
            model, epoch=model.epoch, steps=model.global_step, output_path="./"
        )
...
if __name__ == "__main__":
    ...
    evaluate = evaluation.InformationRetrievalEvaluator(
        ir_queries, ir_corpus, ir_relevant_docs, name=choice
    )
