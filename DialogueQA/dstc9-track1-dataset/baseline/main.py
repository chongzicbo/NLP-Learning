...
def main():
    ...
    # Required parameters
    parser.add_argument("--params_file", type=str, default="baseline/configs/detection/params.json", help="JSON configuration file")
    ...
    parser.add_argument("--exp_name", type=str, default="ktd-baseline",
