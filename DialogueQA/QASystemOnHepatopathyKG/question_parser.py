...
class QuestionPaser:
    ...
    def sql_transfer(self, question_type, entities):
        ...
        if question_type == "disease_cause":
            sql = [
                "MATCH (m:Disease) where m.name = '{0}' return m.name, m.cause".format(
                    i
                )
                for i in entities
            ]
        ...
        # 查询疾病的防御措施
            ...
            sql = [
                "MATCH (m:Disease) where m.name = '{0}' return m.name, m.prevent".format(
                    i
                )
                for i in entities
            ]
        ...
        # 查询疾病的持续时间
            ...
            sql = [
                "MATCH (m:Disease) where m.name = '{0}' return m.name, m.cure_lasttime".format(
                    i
                )
                for i in entities
            ]
        ...
        # 查询疾病的治愈概率
            ...
            sql = [
                "MATCH (m:Disease) where m.name = '{0}' return m.name, m.cured_prob".format(
                    i
                )
                for i in entities
            ]
        ...
        # 查询疾病的治疗方式
            ...
            sql = [
                "MATCH (m:Disease) where m.name = '{0}' return m.name, m.cure_way".format(
                    i
                )
                for i in entities
            ]
        ...
        # 查询疾病传染性
            ...
            sql = [
                "MATCH (m:Disease) where m.name = '{0}' return m.name, m.get_way".format(
                    i
                )
                for i in entities
            ]
        ...
        # 查询疾病的易发人群
            ...
            sql = [
                "MATCH (m:Disease) where m.name = '{0}' return m.name, m.easy_get".format(
                    i
                )
                for i in entities
            ]
        ...
        # 查询疾病是否可以吃某种食物：
            ...
            sql = [
                "MATCH (m:Disease) where m.name = '{0}' return m.name, m.can_eat".format(
                    i
                )
                for i in entities
            ]
