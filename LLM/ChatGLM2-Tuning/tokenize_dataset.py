...
def read_jsonl(path, max_seq_length, skip_overlength=False):
    model_name = "THUDM/chatglm2-6b"  # "THUDM/chatglm-6b"
...
def main():
    ...
    parser.add_argument(
        "--jsonl_path", type=str, default="example_data/luxun_data.jsonl"
    )
    parser.add_argument("--save_path", type=str, default="data/luxun")
