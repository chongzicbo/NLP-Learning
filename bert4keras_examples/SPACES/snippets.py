...
# 自定义词典
user_dict_path = '/root/cail2020/sfzyx/datasets/user_dict.txt.txt'
user_dict_path_2 = '/root/cail2020/sfzyx/datasets/user_dict_2.txt.txt'
...
# 标注数据
data_json = '/root/cail2020/sfzyx/datasets/train.json.json'
