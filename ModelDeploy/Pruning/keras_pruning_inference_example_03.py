...
ds_train = prepare_dataset(ds_train, buffer_size=ds_info.splits["train"].num_examples)
...
dense_model = keras.Sequential(
    [
        ...
        keras.layers.Conv2D(
            filters=8, kernel_size=(3, 3), strides=(2, 2), padding="valid"
        ),
...
dense_model.fit(ds_train, epochs=2, validation_data=ds_val)
...
model_for_pruning.fit(ds_train, epochs=15, validation_data=ds_val, callbacks=callbacks)
