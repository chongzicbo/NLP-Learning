...
def main():
    ...
    parser.add_argument(
        "--model", "-m", type=str, default=None, help="model path, as for HF"
    )
    parser.add_argument(
        "--choice", "-c", type=int, default=0, help="known good models by index, [0-4]"
    )
    parser.add_argument(
        "--tensor-parallel-size", "-t", type=int, default=1, help="tensor parallel size"
    )
