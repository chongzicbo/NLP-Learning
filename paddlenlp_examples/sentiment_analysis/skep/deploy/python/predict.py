...
parser.add_argument('--model_name', choices=['skep_ernie_1.0_large_ch', 'skep_ernie_2.0_large_en'],
                    ...
                    help="Select which model to train.json, defaults to skep_ernie_1.0_large_ch.")
...
if __name__ == "__main__":
    ...
    predictor = Predictor(
        args.model_file, args.params_file, args.device, args.max_seq_length
    )

    tokenizer = ppnlp.transformers.SkepTokenizer.from_pretrained(args.model_name)
