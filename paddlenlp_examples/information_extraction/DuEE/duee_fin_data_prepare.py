...
@author: chengbo
@software: PyCharm
@file: duee_fin_data_prepare.py
@time: 2022/6/23 13:47
"""
...
if __name__ == "__main__":
    ...
    write_by_lines("{}/train.json.json".format(sentence_dir), train_sent)
    ...
    print("train.json {} dev {} test {}".format(len(train_sent), len(dev_sent),
                                           len(test_sent)))
    ...
    train_tri = data_process("{}/train.json.json".format(sentence_dir), "trigger")
    ...
    train_role = data_process("{}/train.json.json".format(sentence_dir), "role")
    ...
    trian_enum = enum_data_process("{}/train.json.json".format(sentence_dir))
    write_by_lines("{}/train.json.tsv".format(enum_save_dir), trian_enum)
    ...
    print("train.json {} dev {} test {}".format(len(trian_enum), len(dev_enum),
                                           len(test_enum)))
