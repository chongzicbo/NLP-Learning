...
@author: chengbo
@software: PyCharm
@file: duee_fin_postprocess.py
@time: 2022/6/23 13:50
"""
...
def predict_data_process(trigger_file, role_file, schema_file, save_path):
    ...
    for d in trigger_data:
        ...
        pred_ret.append(
            {"id": d_json["id"], "text": d_json["text"], "event_list": event_list}
        )
...
if __name__ == "__main__":
    ...
    predict_data_process(
        args.trigger_file, args.role_file, args.schema_file, args.save_path
    )
