...
@author: chengbo
@software: PyCharm
@file: run_ann_data_gen.py
@time: 2022/6/24 16:33
"""
import sys
import os
import numpy as np
...
# Required parameters
parser.add_argument("--similar_text_pair_file", default=None, type=str, required=True,
...
parser.add_argument("--ann_data_dir", default=None, type=str, required=True,
...
parser.add_argument("--end_ann_step", default=1000000, type=int,
...
parser.add_argument("--num_negative_sample", default=5, type=int,
...
parser.add_argument("--hnsw_max_elements", default=1000000, type=int,
...
def ann_data_gen(args):
    ...
    while latest_ann_data_step <= args.end_ann_step:
        ...
        if next_checkpoint == last_checkpoint:
            ...
            logger.info(
                "start generate ann data using checkpoint:{}".format(next_checkpoint)
            )
