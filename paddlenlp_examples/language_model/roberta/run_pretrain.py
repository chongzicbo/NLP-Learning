...
# yapf: disable
parser.add_argument("--model_name_or_path", default='roberta-en-base', type=str, required=False,
                    help="Path to pre-trained model")
parser.add_argument("--input_file", default='wiki', type=str, required=False,
                    help="The input directory where the model predictions and checkpoints will be written.")
parser.add_argument("--output_dir", default='ckp/', type=str, required=False,
...
def do_train(args):
    ...
    # Load model and train.json from scratch
    ...
    train_ds = tokenized_datasets["train.json"]
