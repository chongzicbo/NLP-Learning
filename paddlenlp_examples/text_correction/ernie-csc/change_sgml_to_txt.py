...
parser.add_argument("--input", "-i", default="train.json.sgml", type=str)
parser.add_argument("--output", "-o", default="train.json.txt", type=str)
    ...
    with open(args.output, "w", encoding="utf-8") as fw:
        ...
        for example in example_nodes:
            ...
            for mistake in mistakes:
                loc = (
                    int(mistake.getElementsByTagName("LOCATION")[0].childNodes[0].data)
                    - 1
                )
                correction = (
                    mistake.getElementsByTagName("CORRECTION")[0].childNodes[0].data
                )
