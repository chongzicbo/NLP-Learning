...
def parse_args():
    ...
    parser.add_argument("--task_name", default="atis_slot", type=str,
                        help="The name of the task to train.json.")
    ...
    parser.add_argument("--data_dir", default="E:\\opensource_data\\对话问答\\DGU_datasets\\DGU_datasets", type=str,
    ...
    parser.add_argument("--max_seq_len", default=None, type=int,
                        help="The maximum total input sequence length after tokenization for trainng. Sequences longer than this will be truncated, sequences shorter will be padded.")
    parser.add_argument("--test_max_seq_len", default=None, type=int,
                        help="The maximum total input sequence length after tokenization for testing. Sequences longer than this will be truncated, sequences shorter will be padded.")
    ...
    parser.add_argument("--device", type=str, default="cpu", help="Device for selecting for the training.")
