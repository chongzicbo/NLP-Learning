...
def parse_args():
    ...
    parser.add_argument('--model_name_or_path', type=str, default='unified_transformer-12L-cn',
    ...
    parser.add_argument('--train_data_path', type=str, default='./datasets/train.json.txt',
                        help='Specify the path to load train.json data.')
    ...
    parser.add_argument('--batch_size', type=int, default=8192, required=True,
