...
def parse_args():
    ...
    parser.add_argument('--max_response_len', type=int, default=128,
                        help='The maximum response sequence length of training.')
    parser.add_argument('--max_knowledge_len', type=int, default=256,
                        help='The maximum knowledge sequence length of training.')
...
def train(args):
    ...
    train_ds, dev_ds = load_dataset("duconv", splits=("train.json", "dev"))
