...
def parse_args():
    ...
    parser.add_argument(
        "--max_epoch", type=int, default=12, help="Max number of epochs for training."
    )

    parser.add_argument(
        "--max_seq_length", type=int, default=128, help="Max length for sentence."
    )
    ...
    parser.add_argument(
        "--init_scale", type=float, default=0.1, help="Init scale for parameter"
    )
    ...
    parser.add_argument(
        "--padding_idx", type=int, default=0, help="The padding index of embedding."
    )
    ...
    parser.add_argument(
        ...
        default=os.path.join(
            MODEL_HOME, "bert-base-uncased", "bert-base-uncased-vocab.txt"
        ),
    ...
    parser.add_argument(
        "--vocab_size", type=int, default=10000, help="Student model's vocab size."
    )
