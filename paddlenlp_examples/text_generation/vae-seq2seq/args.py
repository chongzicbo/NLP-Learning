...
def parse_args():
    ...
    parser.add_argument(
        "--learning_rate", type=float, default=0.001, help="Learning rate of optimizer."
    )
    ...
    parser.add_argument(
        "--dec_dropout", type=float, default=0.5, help="Drop probability of decoder"
    )

    parser.add_argument(
        "--enc_dropout", type=float, default=0.0, help="Drop probability of encoder."
    )

    parser.add_argument(
        "--init_scale", type=float, default=0.0, help="Init scale for parameter."
    )
    ...
    parser.add_argument(
        "--warm_up", type=int, default=10, help="The number of warm up epoch for KL."
    )

    parser.add_argument(
        "--kl_start", type=float, default=0.1, help="KL start value, up to 1.0."
    )
