...
parser.add_argument(
    "--batch_size", default=12, type=int, help="Batch size per GPU/CPU for training."
)
parser.add_argument(
    "--learning_rate",
    default=3e-5,
...
parser.add_argument(
    "--early_stop", action="store_true", default=6, help="Epoch before early stop."
)
parser.add_argument(
    "--early_stop_nums", type=int, default=6, help="Number of epoch before early stop."
)
parser.add_argument(
    "--epochs",
    default=1000,
...
parser.add_argument(
    "--logging_steps", default=5, type=int, help="The interval steps to logging."
)
parser.add_argument(
    "--init_from_ckpt",
    type=str,
...
parser.add_argument(
    "--seed", type=int, default=3, help="random seed for initialization"
)
parser.add_argument(
    "--depth", type=int, default=2, help="The maximum level of hierarchy"
)
