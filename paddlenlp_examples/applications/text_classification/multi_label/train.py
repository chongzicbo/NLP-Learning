...
parser.add_argument(
    "--early_stop", action="store_true", help="Epoch before early stop."
)
parser.add_argument(
...
def train():
    ...
    if args.dataset_dir is not None:
        label_list = {}
        with open(
            os.path.join(args.dataset_dir, "label.txt"), "r", encoding="utf-8"
        ) as f:
        ...
        train_ds, dev_ds = load_dataset(
            args.dataset, name=args.task_name, splits=["train", "dev"]
        )
