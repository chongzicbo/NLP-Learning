...
parser.add_argument("--recall_result_file", type=str, default='recall_result_file',
                    help="The file name of recall result")
...
if __name__ == "__main__":
    ...
    trans_func = partial(
        convert_example_test, tokenizer=tokenizer, max_seq_length=args.max_seq_length
    )
