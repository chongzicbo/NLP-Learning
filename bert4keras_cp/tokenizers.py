...
from bert4keras_cp.snippets import is_string, is_py2
from bert4keras_cp.snippets import open
from bert4keras_cp.snippets import convert_to_unicode
from bert4keras_cp.snippets import truncate_sequences
from bert4keras_cp.snippets import lowercase_and_normalize
    ...
    def encode(self,
        ...
        if maxlen is not None:
            if truncate_from == "right":
                ...
                index = truncate_from
            if second_text is not None and pattern == "S*S*E":
                maxlen += 1
            truncate_sequences(maxlen, index, first_tokens, second_tokens)
        first_token_ids = self.token_to_id(first_tokens)
...
class Tokenizer(TokenizerBase):
    ...
    def __init__(self, token_dict, do_lower_case=False, word_max_len=200, **kwargs):
        ...
        self._word_maxlen = word_max_len
...
if __name__ == '__main__':
    ...
    mapping = tokenizer.rematch(text, tokenized_word)
    print(mapping)
