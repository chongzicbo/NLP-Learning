...
def get_model(name, dataset):
    ...
    if name == "lr":
        ...
        return ProductNeuralNetworkModel(
            field_dims, embed_dim=16, mlp_dims=(16,), method="inner", dropout=0.2
        )
    elif name == "opnn":
        return ProductNeuralNetworkModel(
            field_dims, embed_dim=16, mlp_dims=(16,), method="outer", dropout=0.2
        )
    elif name == "dcn":
        return DeepCrossNetworkModel(
            field_dims, embed_dim=16, num_layers=3, mlp_dims=(16, 16), dropout=0.2
        )
    elif name == "nfm":
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset_path",
        default="/mnt/e/opensource_data/RecSys/ml-1m/ml-1m/ratings.dat",
