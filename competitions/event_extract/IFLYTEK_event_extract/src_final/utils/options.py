...
class BaseArgs:
    ...
    def initialize(parser: argparse.ArgumentParser):
        # args for path
        parser.add_argument('--raw_data_dir', default="./data/final/raw_data",
                            help='the data dir of raw data')

        parser.add_argument('--mid_data_dir', default="./data/final/mid_data",
                            help='the mid data dir')

        parser.add_argument('--aux_data_dir', default="./data/final/preliminary_clean",
                            help='preliminary train data dir')

        parser.add_argument('--output_dir', default='./out/',
                            help='the output dir for model checkpoints')

        parser.add_argument('--bert_dir', default='e:/opensource_data/pretrained_model/huggingface/chinese-bert-wwm-ext',
